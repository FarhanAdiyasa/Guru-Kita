          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {displayTeachers.map((teacher) => (
              <div
                ...
                className={`bg-white rounded-xl shadow-lg overflow-hidden cursor-pointer transition-all hover:shadow-xl hover:-translate-y-1 ${selectedTeacher?.id === teacher.id
              ...
              >
                  ...
                  <div className="text-center">
                    ...
                    {teacher.source && (
                      <a
                        ...
                        className="text-white/80 text-xs underline hover:text-white mt-2 inline-block"
                      >
                        Sumber Data ↗
                      </a>
                    )}
                ...
                <div className="p-6 bg-gradient-to-br from-yellow-50 to-orange-50">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                      <div
                        className={`h-full rounded-full transition-all ${teacher.monthlySalary < 2500000
                            ? 'bg-red-500'
                  ...
                  <div className="text-center">
                    <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium ${teacher.monthlySalary < 2500000
                ...
                <div className="p-4 bg-white">
                  <button
                    className={`w-full py-3 px-4 rounded-lg font-bold transition-all ${selectedTeacher?.id === teacher.id
